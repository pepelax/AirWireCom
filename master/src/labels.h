...
//
// Метки — чисто косметические, отображаются только на OLED.
// Дескрипторы Windows не используются (CDC не поддерживает).
// Baud rate управляется автоматически через CDC line coding.
